...
if ($result -eq 'Yes') {
New-Item ".\Your deNch.xml" -ItemType File -Value '<?xml version="1.0" encoding="utf-8"?>
<Preset xmlns="urn:schemas-nliteos-com:pn.v1">
	...
	<ApplyOptions>
		...
		<AutoIsoFile>deNch_FOR_DESKTOPS.iso</AutoIsoFile>
		<AutoIsoLabel>deNch</AutoIsoLabel>
...
$ButtonType = [System.Windows.MessageBoxButton]::YesNo
$MessageIcon = [System.Windows.MessageBoxImage]::Question
$MessageBody = "deNch Preset Created"
$MessageTitle = "deNch Message"
$Result = [System.Windows.MessageBox]::Show($MessageBody,$MessageTitle,$ButtonType,$MessageIcon)
if ($result -eq 'Yes') {
